...
const Achievements = () => {
  const achievements = [
    // { name: "New Start", date: "2022-01-01", style: "w-[100px] h-[100px] rounded-full relative group"},
    ...
    { name: "New Start", date: "2022-01-01", style: "w-[100px] h-[100px] rounded-full relative group"},
    { name: "Hey Friendo", date: "2022-02-15" , style: "w-[100px] h-[100px]  rounded-full relative group"},
    { name: "Hi-Projector", date: "2022-03-20" , style: "w-[100px] h-[100px]  rounded-full relative group"},
    { name: "Star Power", date: "2022-04-05", style: "w-[100px] h-[100px] rounded-full relative group" },
  ];
      ...
      <div className="flex gap-5">
        {achievements.map((achievement, index) => (
          ...
          >
            ...
            <SpinningSphere radius={8} spinDirectionX={0} spinDirectionY={0}  />
          </div>
        ))}
      </div>
    </FeatureBox>
